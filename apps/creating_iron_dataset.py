...
def main(database: str, table: str, outfile: str):
    ...
    for id_component, group in grouped_by_component:
        aux = group[["component", "component_type", "machine_type", "ironLSC", "ironLSM", "iron"]].values
        if pd.isna(aux).any():
            continue
        else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--outfile', type=str, default="../datasets/iron_dataset-idsandlimits.h5")
